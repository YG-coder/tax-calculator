    ...
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="calc-card p-8 space-y-8 text-sm leading-7 text-slate-600">
        ...
        <section>
          ...
          <p className="mt-2">
            운영자는 한국 직장인, 프리랜서, 개인사업자가 자주 확인하는 세금·급여 계산 항목을
            일반 사용자의 관점에서 정리하고, 국세청 공개 자료와 관련 법령 기준을 참고하여
            계산기 구조와 안내 문구를 구성했습니다. 동일한 운영자가 만든
        ...
        {/* 운영 원칙 — E-E-A-T 보강 */}
        <section>
          <h2 className="text-base font-bold text-slate-800 mb-2">운영 원칙</h2>
          <p>
            taxsim.kr는 세무 자문이 아닌 <strong>참고용 계산 도구</strong>로서, 다음 원칙을
            바탕으로 콘텐츠와 계산 로직을 관리합니다.
          </p>
          <ul className="list-disc pl-5 space-y-2 mt-3">
            <li>
              <strong>국세청 공개 자료를 1차 출처로 사용</strong> — 모든 세율, 공제 한도,
              신고 절차는 국세청 홈택스, 국세법령정보시스템, 관련 법령 본문을 기준으로 작성하며
              개인 의견이나 사례를 일반화하지 않습니다.
            </li>
            <li>
            ...
            <li>
              ...
              (반영하지 않은 공제·중과세 항목 등)를 명시하고, 실제 신고 시 국세청 홈택스
              또는 세무 전문가 확인을 권장합니다.
            </li>
            <li>
              <strong>입력값은 사용자 브라우저에서만 처리</strong> — 금액·소득 정보는
              서버로 전송되지 않으며 별도 저장하지 않습니다.
            </li>
            <li>
              <strong>오류 제보 채널 운영</strong> — 계산 결과나 안내 문구에 오류가
              확인되면 <Link href="/contact" className="text-blue-600 hover:underline">문의 페이지</Link>
              {' '}또는 이메일로 제보를 받아 빠르게 검토·수정합니다.
            </li>
          </ul>
        </section>
