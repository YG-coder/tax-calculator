...
export default function TermsPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold mb-8 text-center">이용안내</h1>
      ...
      <div className="calc-card p-8 space-y-8 text-sm leading-7 text-slate-600">
        ...
        <section>
          ...
          <p>
            ...
            참고용 계산 서비스입니다. 본 사이트는 아래 세금 계산기를 제공합니다.
          </p>
        ...
        <section>
          <h2 className="text-base font-bold text-slate-800 mb-2">2. 계산 결과의 한계</h2>
          <p>
            각 계산기는 사용자가 입력한 값과 일반적인 세율·공제 구조를 기준으로 결과를 제공합니다.
            실제 세금은 공제 항목, 감면 여부, 필요경비, 비과세 항목, 개인별 상황,
            법령 개정, 신고 시점 등에 따라 달라질 수 있습니다.
          </p>
          <p className="mt-2">
            본 사이트의 계산 결과는 참고용으로 활용해야 하며,
            실제 세금 신고나 정산 시에는 국세청 홈택스 또는 세무 전문가 안내를 통해 확인하는 것이 필요합니다.
          </p>
        </section>

        <section>
          <h2 className="text-base font-bold text-slate-800 mb-2">3. 법적 책임 제한</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-bold text-slate-800 mb-2">4. 서비스 변경 및 중단</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-bold text-slate-800 mb-2">5. 외부 링크 및 참고 정보</h2>
          <p>
            본 사이트는 사용자 편의를 위해 국세청 홈택스, 연봉계산기.kr 등 외부 사이트 링크를
            제공할 수 있습니다. 외부 링크는 정보 제공 목적이며, 해당 사이트의 정보 정확성·운영 정책에 대해서는
            본 사이트가 책임지지 않습니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            반드시 공식 자료와 전문가 검토를 함께 활용하시기 바랍니다.
          </p>
        </section>
