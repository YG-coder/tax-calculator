...
export const metadata: Metadata = {
    ...
    description:
        "부가세 계산기, 종합소득세 계산기, 원천징수 계산기, 퇴직금 계산기, 프리랜서 3.3% 계산기, 4대보험 계산기를 무료로 제공합니다. 복잡한 세금을 간편하게 계산하세요.",
    ...
    openGraph: {
        ...
        description:
            "부가세, 종합소득세, 원천징수, 퇴직금, 프리랜서 3.3%, 4대보험 계산기를 한 번에 제공",
        url: "https://taxsim.kr",
        siteName: "세금계산기",
        locale: "ko_KR",
        type: "website",
        ...
        <footer className="bg-white border-t py-10 mt-20">
            <div className="container mx-auto px-4 text-center text-slate-400 text-sm space-y-4">
                ...
                <p className="text-xs leading-relaxed max-w-xl mx-auto">
                    ...
                    원천징수 계산기, 퇴직금 계산기, 프리랜서 3.3% 계산기, 4대보험 계산기를
                    제공하며 모든 계산 결과는 참고용으로 실제 세금과 차이가 있을 수 있습니다.
                </p>
            </div>
        </footer>
        </body>
